...
<html lang="en">
  ...
  <body>
    ...
    <?php
      ...
      $query = "SELECT * FROM student_train_map WHERE s_id='$s_id';";
          ...
          <!-- DASHBOARD START -->
            <div class="content-wrapper">
              ...
              <div class="row">
                ...
                <!-- 4 CARDS START -->
                  <?php
                    $code = "SELECT home_stn FROM student WHERE s_id = '$s_id';";
                    $count = mysqli_query($conn, $code);
                    $home = mysqli_fetch_assoc($count);
                  ?>
                  <div class="col-md-6 grid-margin transparent">
                    <div class="row">
                      <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                          <div class="card-body">
                            <p class="mb-4">Registered Home Station</p>
                            <p class="fs-30 mb-2"><?php echo $home['home_stn'] ; ?></p>
                          </div>
                        </div>
                      </div>
                      ...
                      <?php
                        $code = "SELECT COUNT(tc_no) AS t_tc FROM student_train_map WHERE s_id='$s_id';";
                        $count = mysqli_query($conn, $code);
                      ...
                      <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-dark-blue">
                          <div class="card-body">
                            <p class="mb-4">Total Train Concession Taken</p>
                            <p class="fs-30 mb-2"><?php echo $tc; ?></p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <?php
                        $code = "SELECT exp_date FROM student_train_map WHERE issue_date='$con' and s_id='$s_id';";
                        $count = mysqli_query($conn, $code);
                        $expiry = mysqli_fetch_assoc($count);

                        if($expiry['exp_date'] == NULL) {
                          $exp = 'None';
                        }
                        else {
                          $exp= $expiry['exp_date'];
                      ...
                      <div class="col-md-6 stretch-card transparent">
                        <div class="card card-light-danger">
                          <div class="card-body">
                            <p class="mb-4">Expiry Date of Current Pass</p>
                            <p class="fs-30 mb-2"><?php echo $exp; ?></p>
                          </div>
                        </div>
                      </div>
                    </div>
