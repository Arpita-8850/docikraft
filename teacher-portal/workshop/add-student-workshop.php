	...
	<body>
						...
						<form  action="" method = "POST"> 
							...
							<div class="container px-6 mx-auto grid">
								...
								<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
									...
									<label class="block text-sm">
										<span class="text-gray-700 dark:text-gray-400"> Tool Number</span>
										<input
											type="text" 
											name="too_id"
											class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
		...
		<?php		
			...
			{	
				...
				$query = "INSERT INTO student_workshop_map (s_id, workshopstatus, too_id, dues) 
                          VALUES ('$s_id','$workshopstatus','$too_id','$dues');";
				$data = mysqli_query($conn, $query);
                
				if($data)
				{
					echo "<script type='text/javascript'>alert('Data Added.');  location.replace('all-student-workshop.php') </script>";
				}
				else
				{
					echo "<script type='text/javascript'>alert('Data not added. Please try again later.');  location.replace('all-student-workshop.php') </script>";
				}
			}
		?>
	</body>
