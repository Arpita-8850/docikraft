				...
				<main class="h-full overflow-y-auto">
					<div class="container px-6 mx-auto grid">
						...
						<!-- Cards Section START-->
							...
							<?php
								$sql = "SELECT COUNT(too_id) as b_tools, COUNT(DISTINCT s_id) as t_students, SUM(dues) as t_dues FROM student_workshop_map;";
							...
							<!-- Card 2 START -->
								...
								<div>
									<p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400"> Tools Borrowed </p>
									<p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
										<?php echo $row['b_tools']; ?>
									</p>
								</div>
								</div>
							<!-- Card 2 END -->
											...
											<?php
													while($result = mysqli_fetch_assoc($data))
													{
														echo"<tr class='text-gray-700 dark:text-gray-400'>
																<td class='px-4 py-3'>".$result['tool_id']."</td>
