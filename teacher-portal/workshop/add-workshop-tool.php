	...
	<body>
					...
					<main class="h-full pb-16 overflow-y-auto">
						<form  action="" method = "POST"> 
							...
							<div class="container px-6 mx-auto grid">
								<h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"> Add New Tool</h2>
								<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
									
									<label class="block text-sm">
										<span class="text-gray-700 dark:text-gray-400"> Tool Id </span>
										<input
											type="text" 
											autocomplete="off"
											name="tool_id"
									...
									<label class="block text-sm">
										<span class="text-gray-700 dark:text-gray-400"> Tool Name </span>
										<input
											type="text" 
											name="tool_name" 
											autocomplete="off"
		...
		<?php		
			...
			{	
				...
				$query = "INSERT INTO workshop (tool_id, tool_name) 
                          VALUES ('$tool_id','$tool_name');";
				$data = mysqli_query($conn, $query);
                
				if($data)
				{
					echo "<script type='text/javascript'>alert('Data Added.');  location.replace('workshop-home.php') </script>";
				}
				else
				{
					echo "<script type='text/javascript'>alert('Data not added. Please try again later.');  location.replace('workshop-home.php') </script>";
				}
			}
		?>
	</body>
