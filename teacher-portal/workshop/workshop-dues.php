...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
	...
	<body>
		<?php
			...
			error_reporting(0);
			$query = "SELECT * FROM student s, student_workshop_map sw, workshop w WHERE s.s_id= sw.s_id and sw.too_id=w.tool_id and sw.dues > 0 ORDER BY sw.s_id";
		...
		<div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">		
			...
			<div class="flex flex-col flex-1 w-full">
				...
				<main class="h-full pb-16 overflow-y-auto">
					...
					<h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"> Students Dues Data</h2>
