	...
	<body>
						...
						<form  action="" method = "POST"> 
							<?php
								...
								$records = mysqli_query($conn,"SELECT * FROM student s, 
																			 student_workshop_map sw, 
																			 workshop w 
																		WHERE sw.too_id=w.tool_id 
																		AND sw.too_id = '$tool_id'
																		AND s.s_id = sw.s_id 
								...
								{ 
									echo' 
										<div class="container px-6 mx-auto grid">
											...
											<p class="my-2 text-1xl text-gray-700 dark:text-gray-200"><b>Tool Id:</b> '.$data['too_id'].' </p>
											<p class="my-3 text-1xl text-gray-700 dark:text-gray-200"><b>Tool name:</b> '.$data['tool_name'].' </p>
											<br>
											<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
												<div class="mt-4 text-sm">
													<span class="text-gray-700 dark:text-gray-400"> Workshop Status</span>
													<div class="mt-2">       
		...
		<?php		
			if($_POST['submit'])
			{
				...
				$query = "UPDATE student_workshop_map SET workshopstatus='$workshopstatus', dues='$dues'  WHERE s_id='$rollno' AND too_id='$tool_id'";
				$data = mysqli_query($conn, $query);
				if($data)
				{
					echo "<script type='text/javascript'>alert('Data updated.');  location.replace('all-student-workshop.php') </script>";
				}
				else
				{
					echo "<script type='text/javascript'>alert('Data not updated. Please try again later.');  location.replace('workshop-home.php') </script>";
				}
			}
		?>
	</body>
