				...
				<main class="h-full overflow-y-auto">
					<div class="container px-6 mx-auto grid">
						...
						<!-- Cards Section START-->
							...
							<?php
								$sql = "SELECT COUNT(book_id) as b_books, COUNT(DISTINCT s_id) as t_students, SUM(dues) as t_dues FROM student_library_map;";
								$query = mysqli_query($conn, $sql);
								$row = mysqli_fetch_assoc($query);

								$code = "SELECT COUNT(book_id) as t_book FROM library;";
							...
							<!-- Card 2 START -->
								...
								<div>
									<p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400"> Books Borrowed </p>
									<p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
										<?php echo $row['b_books']; ?>
									</p>
								</div>
								</div>
							<!-- Card 2 END -->
								...
								<div class="w-full overflow-x-auto">
									<table class="order-table w-full whitespace-no-wrap">
										<thead>
											...
											<th class="px-4 py-3">Book Number</th>
											...
											<?php
													while($result = mysqli_fetch_assoc($data))
													{
														echo"<tr class='text-gray-700 dark:text-gray-400'>
																<td class='px-4 py-3'>".$result['book_id']."</td>
																<td class='px-4 py-3 text-sm'>".$result['book_name']."</td>
																<td class='px-4 py-3 text-xs'>".$result['author_name']."</td>
															</tr>";
													}
											?>					
										</tbody>	
