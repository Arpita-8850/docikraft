	...
	<body>
					...
					<main class="h-full pb-16 overflow-y-auto">
						<form  action="" method = "POST"> 
							...
							<div class="container px-6 mx-auto grid">
								<h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"> Add New Book</h2>
								<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
									
									<label class="block text-sm">
										<span class="text-gray-700 dark:text-gray-400"> Book Id </span>
										<input
											type="text" 
											autocomplete="off"
											name="book_id"
									...
									<label class="block text-sm">
										<span class="text-gray-700 dark:text-gray-400"> Book Name </span>
										<input
											type="text" 
											name="book_name" 
											autocomplete="off"
		...
		<?php		
			...
			{	
				...
				$query = "INSERT INTO library (book_id, book_name, author_name) 
                          VALUES ('$book_id','$book_name','$author_name');";
				$data = mysqli_query($conn, $query);
                
				if($data)
				{
					echo "<script type='text/javascript'>alert('Data Added.');  location.replace('library-home.php') </script>";
				}
				else
				{
					echo "<script type='text/javascript'>alert('Data not added. Please try again later.');  location.replace('library-home.php') </script>";
				}
			}
		?>
	</body>
