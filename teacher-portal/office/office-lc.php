...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
	...
	<body>
		<?php
			...
			error_reporting(0);
			$query = "SELECT lc.*, s.* FROM student_vm_map AS lc, student AS s WHERE lc.s_id=s.s_id ORDER BY lc.s_id ASC";
			...
			<div class="flex flex-col flex-1 w-full">
				...
				<main class="h-full overflow-y-auto">
					<div class="container px-6 mx-auto grid">
						<h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Leaving Certificate</h2>

						<!-- Cards Section START-->
							<?php
								$sql = "SELECT COUNT(s_id) as t_lc  FROM student_vm_map;";
