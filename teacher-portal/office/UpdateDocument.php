	...
	<body>
                    ...
                    <main class="h-full pb-16 overflow-y-auto">
						<form  action="" method = "POST"> 
							<?php
								...
								$name = $_GET['name'];
								echo $rn;
								$records = mysqli_query($conn,"SELECT * FROM student s, student_doc_map sd WHERE s.s_id = sd.s_id AND s.s_id= '$rollno'"); // fetch data from database
										...
										<div class="container px-6 mx-auto grid">
                                            ...
                                            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                                                ...
                                                <div class="mt-4 text-sm">
                                                    <span class="text-gray-700 dark:text-gray-400"> All Year Fees Cleared</span>
                                                    <div class="mt-2">       
                                                ...
                                                <div class="mt-4 text-sm">
                                                    <span class="text-gray-700 dark:text-gray-400"> 10th Marksheet</span>
                                                    <div class="mt-2">       
                                                        <label class="inline-flex items-center text-gray-600 dark:text-gray-400">
                                                            <input
                                                                type="radio"
                                                ...
                                                <div class="mt-4 text-sm">
                                                    <span class="text-gray-700 dark:text-gray-400"> 12th Marksheet</span>
                                                    <div class="mt-2">       
                                                        <label class="inline-flex items-center text-gray-600 dark:text-gray-400">
                                                            <input
                                                                type="radio"
                                                ...
                                                <div class="mt-4 text-sm">
                                                    <span class="text-gray-700 dark:text-gray-400"> Diploma Certificate</span>
                                                    <div class="mt-2">       
                                                        <label class="inline-flex items-center text-gray-600 dark:text-gray-400">
                                                            <input
                                                                type="radio"
		...
		<?php		
			if($_POST['submit'])
			{
				...
				else if($_REQUEST["fees"] == "no") {
					$fees = "No";
				}

                if($_REQUEST["tenth_mks"] == "yes") {
					$tenth_mks = "Yes";
				} 
				else if($_REQUEST["tenth_mks"] == "no") {
					$tenth_mks = "No";
				}

                if($_REQUEST["twelfth_mks"] == "yes") {
					$twelfth_mks = "Yes";
				} 
				else if($_REQUEST["twelfth_mks"] == "no") {
					$twelfth_mks = "No";
				}

                if($_REQUEST["diploma_doc"] == "yes") {
					$diploma_doc = "Yes";
				} 
				else if($_REQUEST["diploma_doc"] == "no") {
					$diploma_doc = "No";
				}

				$query = "UPDATE student_doc_map 
                          SET 
                            fees='$fees', 
                            tenth_mks='$tenth_mks', 
                            twelfth_mks='$twelfth_mks', 
                            diploma_doc='$diploma_doc' 
                          WHERE s_id='$rollno'";
				$data = mysqli_query($conn, $query);
				if($data) {
					echo "<script type='text/javascript'>alert('Data Updated.');  location.replace('office-documents.php') </script>";
					exit;
				}
				else {
					echo "<script type='text/javascript'>alert('Data not updated. Please try again later.');  location.replace('office-documents.php') </script>";
				}
			}
		?>
	</body>
