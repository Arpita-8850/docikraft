                            ...
                            <div class="container px-6 mx-auto grid">
                                ...
                                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                                    ...
                                    <label class="block text-sm">
                                        <span class="text-gray-700 dark:text-gray-400"> Roll no</span>
                                        <input
                                            type="text" 
                                            name="s_id" 
                                            autocomplete="off"
                                    ...
                                    <label class="block text-sm">
                                        <span class="text-gray-700 dark:text-gray-400">Religion </span>
                                        <input
                                            type="text" 
                                            name="religion" 
                                            autocomplete="off"
                                    ...
                                    <label class="block text-sm">
                                        <span class="text-gray-700 dark:text-gray-400">Home Station</span>
                                        <input
                                            type="text" 
                                            name="home_stn" 
                                            autocomplete="off"
                                    ...
                                    <label class="block text-sm">
                                        <span class="text-gray-700 dark:text-gray-400">Last Institute Attended </span>
                                        <input
                                            type="text" 
                                            name="ila" 
                                            autocomplete="off"
                                    ...
                                    <label class="block text-sm">
                                        <span class="text-gray-700 dark:text-gray-400">Date of Addmission</span>
                                        <input
                                            type="text" 
                                            name="doa" 
                                            autocomplete="off"
                                    ...
                                    <label class="block text-sm">
                                        <span class="text-gray-700 dark:text-gray-400">Reason of Leaving Institute</span>
                                        <input
                                            type="text" 
                                            name="reason" 
                                            autocomplete="off"
		...
		<?php
			...
			{			
				...
				$query = "INSERT INTO student
                            (s_id, branch, first_name, last_name, mother_name, religion, gender, 
                            dob, pob, s_email, s_pwd, phone, year, home_stn, age, ila, doa, reason, remark) 
                        VALUES 
                            ('$s_id','$branch','$first_name','$last_name','$mother_name','$religion','$gender',
                            '$dob','$pob','$s_email','$s_pwd','$phone','$year','$home_stn','$age','$ila',
                            '$doa','$reason','$remark');";
				$data = mysqli_query($conn, $query);
                
				if($data)
				{
					echo "<script type='text/javascript'>alert('Data Added.');  location.replace('all-student-office.php') </script>";
				}
				else
				{
					echo "<script type='text/javascript'>alert('Data not added. Please try again later.');  location.replace('all-student-office.php') </script>";
				}
			}
		?>
	</body>
