	...
	<body>
                    ...
                    <main class="h-full pb-16 overflow-y-auto">
						<form  action="" method = "POST"> 
							<?php
								...
								$name = $_GET['name'];
								echo $rn;
								$records = mysqli_query($conn,"SELECT * FROM student WHERE s_id= '$rollno'"); // fetch data from database
		...
		<?php		
			...
			{			
				...
				if($data)
				{
					echo "<script type='text/javascript'>alert('Data Updated.');  location.replace('all-student-office.php') </script>";
				}
				else
				{
					echo "<script type='text/javascript'>alert('Data not updated. Please try again later.');  location.replace('all-student-office.php') </script>";
				}
			}
		?>
	</body>
