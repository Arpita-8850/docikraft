...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
	...
	<body>
		<?php
			...
			error_reporting(0);
			$query = "SELECT b.*, s.first_name, s.last_name FROM student_bonafide_map AS b, student AS s WHERE b.s_id=s.s_id ORDER BY b.bonafide_no ASC";
			...
			<div class="flex flex-col flex-1 w-full">
				...
				<main class="h-full overflow-y-auto">
					<div class="container px-6 mx-auto grid">
						<h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Bonafide</h2>

						<!-- Cards Section START-->
							<?php
								$sql = "SELECT COUNT(s_id) as t_bonafide  FROM student_bonafide_map;";
								$query = mysqli_query($conn, $sql);
								$row = mysqli_fetch_assoc($query);

								$code = "SELECT issue_date FROM student_bonafide_map ORDER BY issue_date DESC LIMIT 1";
								...
								<div class="w-full overflow-x-auto">
									<table class="order-table w-full whitespace-no-wrap">
										<thead>
											...
											<th class="px-4 py-3">Bonafide No </th>
											...
											<?php
													while($result = mysqli_fetch_assoc($data))
													{
														echo"<tr class='text-gray-700 dark:text-gray-400'>
																<td class='px-4 py-3 text-xs'>".$result['bonafide_no']."</td>
                                                                ...
                                                                <td class='px-4 py-3 text-xs'>".$result['reason']."</td>
															</tr>";
													}
											?>					
										</tbody>	
