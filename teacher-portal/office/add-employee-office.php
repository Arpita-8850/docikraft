		...
		<?php
			...
			{			
				...
				$query = "INSERT INTO employee
                            (e_name, e_email, e_pwd, department, Designation, Salary, Join_Date) 
                        VALUES 
                            ('$e_name', '$e_email', '$e_pwd', '$department', '$Designation', '$Salary', '$Join_Date');";
				...
				if($data)
				{
					echo "<script type='text/javascript'>alert('Data Added.');  location.replace('office-home.php') </script>";
				}
				else
				{
					echo "<script type='text/javascript'>alert('Data not added. Please try again later.');  location.replace('office-home.php') </script>";
				}
			}
		?>
	</body>
