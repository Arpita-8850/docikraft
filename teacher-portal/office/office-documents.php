...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
	...
	<body>
		<?php
			...
			error_reporting(0);
			$query = "SELECT * FROM student s, student_doc_map sd WHERE s.s_id=sd.s_id ORDER BY sd.s_id ASC";
		...
		<div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">		
			...
			<div class="flex flex-col flex-1 w-full">
				...
				<main class="h-full pb-16 overflow-y-auto">
					...
					<h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"> Students Documents</h2>
						...
						<div class="w-full overflow-hidden rounded-lg shadow-xs">
							<div class="w-full overflow-x-auto">
								...
								<thead>
                                    ...
                                    <th class="px-4 py-3">All Documents</th>
								...
								<tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
									<?php
										...
										{
                                            if ($result['tenth_mks'] == "Yes" 
                                                && $result['twelfth_mks'] == "Yes" 
                                                && $result['diploma_doc'] == "Yes") 
                                            {
                                                $doc = "Yes";
                                            }
                                            else {
                                            ...
                                            echo"
												<tr class='text-gray-700 dark:text-gray-400'>
													...
													<td class='px-4 py-3 text-sm'>".$result['fees']."</td>
                                                    <td class='px-4 py-3 text-sm'>".$doc."</td>
													<td class='px-4 py-3'>
														<div class='flex items-center space-x-4 text-sm'>
														
															<button class='flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray' aria-label='Edit'>
																<a href='UpdateDocument.php?rollno=$result[s_id]&name=$result[first_name]'>
