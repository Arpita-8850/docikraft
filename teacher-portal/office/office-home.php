			...
			<div class="flex flex-col flex-1 w-full">
				...
				<main class="h-full overflow-y-auto">
					<div class="container px-6 mx-auto grid">
						<h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Employees</h2>

						<!-- Cards Section START-->
							<?php
								$sql = "SELECT COUNT(e_id) as t_employee, COUNT(department) as t_department FROM employee;";
								$query = mysqli_query($conn, $sql);
								$row = mysqli_fetch_assoc($query);

								$code = "SELECT COUNT(s_id) as t_student FROM student;";
											...
											<?php
													while($result = mysqli_fetch_assoc($data))
													{
														echo"<tr class='text-gray-700 dark:text-gray-400'>
																<td class='px-4 py-3'>".$result['e_id']."</td>
																<td class='px-4 py-3 text-sm'>".$result['e_name']."</td>
																<td class='px-4 py-3 text-xs'>".$result['department']."</td>
                                                                <td class='px-4 py-3 text-xs'>".$result['e_email']."</td>
                                                                <td class='px-4 py-3 text-xs'>".$result['Designation']."</td>
                                                                <td class='px-4 py-3 text-xs'>".$result['Salary']."</td>
                                                                <td class='px-4 py-3 text-xs'>".$result['Join_Date']."</td>
															</tr>";
													}
											?>					
										</tbody>	
