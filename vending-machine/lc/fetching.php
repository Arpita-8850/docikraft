  ...
  <body>
    <center>
      <?php
        ...
        $sql = "SELECT * FROM student_vm_map WHERE EXISTS (SELECT s_id FROM student where student.s_id = student_vm_map.s_id and student.s_id='$rollno');";
        $query_run = mysqli_query($conn,$sql);		
        $doc = mysqli_fetch_assoc($query_run);  

        $len = isset($doc['doc_taken'])? : NULL; 
        ...
        if($len == NULL) 
        {
          ...
          if ($row['tenth_mks'] == "Yes" &&  $row['twelfth_mks'] == "Yes" && $row['diploma_doc'] == "Yes")
            {
                $doc = "Yes";
            }
          else 
            ...
            { 
              echo '
                    ...
                    echo '
                        ...
                        <a class="cancel" href="../index.php"><strong>CANCEL</strong></a>
                      ';      
            }
        }
        ...
        {
          echo '<script type="text/javascript">alert("Your LC had already been printed on '.$doc['timestamp'].'");  location.replace("../index.php") </script>';
        } 
